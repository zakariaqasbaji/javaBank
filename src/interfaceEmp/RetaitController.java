...
public class RetaitController implements Initializable {
    ...
    public void validerRetrait() throws MalformedURLException, IOException
    {
        ...
        try{
            comptes.get(indexCompte).retirerMontant(Float.parseFloat(montant.getText()));
            ...
            controller.creerRecuRetrait(num.getText(),montant.getText());
        }catch(Exception e)
                {
